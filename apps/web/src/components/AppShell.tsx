        ...
        <div className="px-5 py-6 border-b border-border">
          <Link to="/" className="flex items-center gap-3">
            <img
              src={logoImg}
              alt="Innovai"
              className="h-9 w-9 rounded-lg border border-gold/25 bg-background/70 object-contain p-1"
            />
            <div>
      ...
      <main className="flex-1 min-w-0">
        <div className="md:hidden border-b border-border px-4 py-3 flex items-center gap-2 bg-sidebar">
          <img
            src={logoImg}
            alt="Innovai"
            className="h-7 w-7 rounded-md border border-gold/25 bg-background/70 object-contain p-1"
          />
