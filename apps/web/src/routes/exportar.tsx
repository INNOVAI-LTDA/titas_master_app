  ...
  if (!grupo)
    return (
      <div className="px-8 py-8">
        <PageHeader title="Exportar Relatório" />
      </div>
    );
        ...
        <div className="flex items-start gap-3 mb-5">
          ...
          <div>
            ...
            <div className="text-sm text-muted-foreground">
              Inclui membros, especialidades, telefones, faturamento bruto e totalizadores. Membros
              sem lançamento aparecem como "Não informado".
            </div>
          </div>
        </div>
